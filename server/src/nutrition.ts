...
export function generateDietAsync(details: any, onProgress: (msg: any) => void) {
  ...
  const nutrientConfig: Record<string, NutrientConfig> = {
    ...
    b1: { target: isMale ? 1.2 : 1.1, essential: true, max: 6.25 },
    b2: { target: isMale ? 1.3 : 1.1, essential: true, max: 6.25 },
    b3: { target: isMale ? 16 : 14, essential: true, max: 35 },
    b5: { target: 5, essential: true, max: 18.75 },
    b6: { target: 1.7, essential: true, max: 12.5 },
    b12: { target: 2.4, essential: true, max: 31.25 },
    folate: { target: 400, essential: true, max: 750 },
    a: { target: isMale ? 900 : 700, essential: true, max: 3000 },
    c: { target: isMale ? 90 : 75, essential: true, max: 312.5, unit: 'mg' },
    ...
    manganese: { target: isMale ? 2.3 : 1.8, essential: true, max: 6.25 },
    phosphorus: { target: 700, essential: true, max: 4000 },
    potassium: { target: isMale ? 3400 : 2600, essential: true, max: 5500 },
    ...
    lysine: { target: details.weight * 38, essential: true, max: 15000 },
    methionine: { target: details.weight * 13, essential: true, max: 5000 },
    phenylalanine: { target: details.weight * 14, essential: true, max: 10000 },
    threonine: { target: details.weight * 20, essential: true, max: 10000 },
